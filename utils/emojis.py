...
EMOJI_37496ALERT = CustomEmoji('37496alert', 1525734723467477234, False)
EMOJI_7CLUB_BAN = CustomEmoji('7club_ban', 1523491174155943936, False)
ROSE = CustomEmoji('_rose', 1525733705342124132, False)
...
BLUEDOT = CustomEmoji('BlueDot', 1525734767578841178, False)
...
DISABLED1 = CustomEmoji('disabled1', 1525734831512879104, False)
DND = CustomEmoji('dnd', 1523491317949268122, False)
ENABLED = CustomEmoji('enabled', 1523491327168348240, False)
ENABLED_160063 = CustomEmoji('enabled_', 1525733712720039986, False)
...
GEAR = CustomEmoji('Gear', 1525734895458975794, False)
GIFD = CustomEmoji('GIFD', 1525734904497705142, False)
GIFN = CustomEmoji('GIFN', 1525734913855324311, False)
GIVEAWAY = CustomEmoji('Giveaway', 1525734922705440901, False)
GIVEAWAY_644980 = CustomEmoji('Giveaway', 1525734922705440901, False)
GIVEAWAYS = CustomEmoji('Giveaways', 1525734931718737940, False)
...
KING = CustomEmoji('king', 1525735098215829633, False)
...
LOADING = CustomEmoji('loading', 1525735113592143872, False)
LOADING_461233 = CustomEmoji('loading', 1525735113592143872, False)
LOGGING = CustomEmoji('logging', 1523491670883045499, False)
MAX__A = CustomEmoji('max__A', 1525735129425776751, False)
MENTION = CustomEmoji('mention', 1525735138061717504, False)
...
OWNER = CustomEmoji('owner', 1525735249974398976, False)
OWNER_433185 = CustomEmoji('owner', 1525735249974398976, False)
PC = CustomEmoji('pc', 1523491987637014649, False)
PREMIUM = CustomEmoji('premium', 1525735265501712424, False)
QUESTIONS = CustomEmoji('questions', 1523492010110226493, False)
RED_DOT = CustomEmoji('red_dot', 1523492025008263220, False)
REDHEART = CustomEmoji('RedHeart', 1525735288159080448, False)
...
SG_RD = CustomEmoji('sg_rd', 1525735317821198457, False)
...
STAR = CustomEmoji('star', 1525735354416631939, False)
STAR_147803 = CustomEmoji('star', 1525735354416631939, False)
...
TIMER = CustomEmoji('timer', 1525735384804233266, False)
U_ADMIN = CustomEmoji('U_admin', 1523492253199499415, False)
UPTIME = CustomEmoji('Uptime', 1525735400906424441, False)
...
WARNING = CustomEmoji('Warning', 1525735437015191562, False)
